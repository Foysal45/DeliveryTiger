...
class LoanSurveryViewModel(private val repository: AppRepository) : ViewModel() {
    ...
    fun previousLoanSurveyResponse(courrierUserId: Int): LiveData<PreviousLoanSurveyResponse> {

        val responseData: MutableLiveData<PreviousLoanSurveyResponse> = MutableLiveData()
